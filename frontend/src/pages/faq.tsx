  ...
  <div className="container full-height content-page">
    ...
    <div className="row mt-3">
      ...
      <div className="question">
        ...
        <p>
          Afin de limiter au maximum les recherches infructueuses avec un terme ou une expression absent(e) des données
          disponibles (+ lien vers entrepôt de données). La recherche libre est possible dans le texte intégral.
        </p>
      </div>
      <div className="question">
