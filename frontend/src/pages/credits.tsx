...
interface Props {}
export const Credits: React.FC<Props> = (props: Props) => {
  return (
    <div className="container full-height content-page">
      ...
      <div className="row mt-3">
        <p>
          ...
          <br />
          Sylvaine Detchemendy, chargée de mission Fonds documentaires à la DRIS, co-pilote du projet Archelec depuis
          2013
          <br />
      ...
      <div className="row mt-3">
        <p>
          <h2>Participants</h2>
          Robin Bouvier, étudiant de l'Université technologique de Compiègne (UTC), stagiaire pour le projet Archelec 4
